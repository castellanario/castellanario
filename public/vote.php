...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($db_connection->query($query)) {
        ...
        if ($votes['upvotes'] > 0 && file_exists($img) && $votes['queued'] == 0) {
            ...
            $message = '<p>La palabra con ID ' . $id . ' ha superado los 10 votos positivos. Revisala antes de subirla a la web.</p><p><img style="border:1px solid black;width:400px;height:400px;" alt="imagen" src="https://castellanario.com/images/' . $id . '.jpg"></p><p><a href="https://castellanario.com/email-ops.php?id=' . $id . '&action=ok-image-upload&tokensito=' . $_ENV['EMAIL_OPS_SEKRET_TOKENSITO'] . '">SII SUBELA, CLARO QUE SIII!</a></p>';
